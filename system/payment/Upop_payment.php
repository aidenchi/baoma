...
class Upop_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$frontEndUrl = get_domain().APP_ROOT.'/upop_response.php';
		$backEndUrl = get_domain().APP_ROOT.'/upop_notify.php';
		...
		$param['orderTime']             = to_date(get_gmtime(),'YmdHis');		   // 交易时间, YYYYmmhhddHHMMSS
		...
		*/
		...
		$button = "<input type='submit' value='去网银在线支付' class=\"formbutton\" />";
