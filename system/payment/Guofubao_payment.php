...
class Guofubao_payment implements payment {
    ...
    public function get_payment_code($payment_notice_id) {
        ...
        /*$data_front_url =  get_domain().APP_ROOT.'/index.php?ctl=payment&act=notify&class_name=Guofubao';
        $data_front_url="";
        $data_return_url = get_domain().APP_ROOT.'/index.php?ctl=payment&act=response&class_name=Guofubao';
        */
        //新
        $data_front_url =  get_domain().APP_ROOT.'/guofubao_callback.php?act=notify';
        //$data_front_url="";
        $data_return_url = get_domain().APP_ROOT.'/guofubao_callback.php?act=response';
        ...
        /* 交易日期 */
        $today = to_date($payment_notice['create_time'], 'YmdHms');
        ...
        $def_url = '<form style="text-align:center;" action="https://www.gopay.com.cn/PGServer/Trans/WebClientAction.do" target="_blank" style="margin:0px;padding:0px" method="get" >';
    ...
    public function get_display_code() {
		...
		if($payment_item)
		{
	        ...
	        $html .=".bk_type_BOCOM{background-position:15px -158px; }"; //交通银行
