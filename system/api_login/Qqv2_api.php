...
class Qqv2_api implements api_login {
	...
	public function get_api_url()
	{
		...
		if($GLOBALS['request']['from']=="wap"){
			...
			$callback = str_replace('sjmapi/', '', $callback);
	...
	public function callback()
	{
		...
		//define('AS_LOG_DIR', APP_ROOT_PATH.'system/api_login/log/');
		//define('AS_DEBUG', true);
		//require APP_ROOT_PATH.'wap/lib/logUtils.php';
		//LogUtils::log_obj($_REQUEST);
		...
		if($user_data)
		{
				...
				if(substr($state,0,4)=="wap_"){
					//LogUtils::log_str("=================1==========");
					//LogUtils::log_obj($user_data);
					
					//es_cookie::set("user_name",$user_data['user_name'],3600*24*30);
					//es_cookie::set("user_pwd",md5($user_data['user_pwd']."_EASE_COOKIE"),3600*24*30);
					//LogUtils::log_str(get_domain().APP_ROOT."/wap/index.php");
					app_redirect(get_domain().APP_ROOT."/wap/index.php");
				}else{
					//LogUtils::log_str("=================11==========");
