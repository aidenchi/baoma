...
class youhuilist
{
	public function index()
	{
		...
		$sql = "select id, supplier_id as merchant_id,begin_time,end_time,name as title,list_brief as content,icon as merchant_logo,create_time,xpoint,ypoint,address as api_address,icon as image_1,
