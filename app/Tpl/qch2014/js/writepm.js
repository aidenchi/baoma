...
function do_send_pm()
{
	...
	var ajaxurl = APP_ROOT+"/shop.php?ctl=ajax&act=check_send";
	$.ajax({ 
		url: ajaxurl,
		dataType: "json",
		type: "POST",
...
function send_pm(uname,content)
{
	...
	var ajaxurl = APP_ROOT+"/shop.php?ctl=ajax&act=send_pm";
	$.ajax({ 
		url: ajaxurl,
		dataType: "json",
		type: "POST",
...
function drop_pm_item()
{
	...
	else
	{
		if(confirm(LANG['CONFIRM_DELETE_PMGROUP']))
		{
			...
			var ajaxurl = APP_ROOT+"/shop.php?ctl=ajax&act=drop_pm_item";
			$.ajax({ 
				url: ajaxurl,
				dataType: "json",
				type: "POST",
