...
'ONLINE_MSN'=>'msn@beiou.com|msn2@beiou.com',
...
'HELP_CATE_LIMIT'=>'4',
'HELP_ITEM_LIMIT'=>'4',
'SHOP_FOOTER'=>'<div style=\"text-align:center;\">[贝欧] <a target=\"_blank\" href=\"http://www.fanwe.com\">http://www.</a>beiou.com<br />
</div>
',
'USER_MESSAGE_AUTO_EFFECT'=>'1',
'SHOP_REFERRAL_HELP'=>'当好友接受您的邀请，在 [贝欧] 上首次成功购买，系统会在 1 小时内返还 ¥20 到您的 [贝欧] 电子账户，下次团购时可直接用于支付。没有数量限制，邀请越多，返利越多。<br />
<br />
...
'COUPON_NAME'=>'贝欧券',
'BATCH_PAGE_SIZE'=>'500',
'COUPON_PRINT_TPL'=>'<div style=\"border:1px solid #000000;padding:10px;margin:0px auto;width:600px;font-size:14px;\"><table class=\"dataEdit\" cellpadding=\"0\" cellspacing=\"0\">	<tbody><tr>    <td width=\"400\">贝欧</td>
...
'EDM_USERNAME'=>'',
'EDM_PASSWORD'=>'',
'SHOP_SEARCH_KEYWORD'=>'服装,手机,零食贝欧',
'REC_HOT_LIMIT'=>'4',
'REC_NEW_LIMIT'=>'4',
'REC_BEST_LIMIT'=>'4',
...
'BIZ_APPLE_PATH'=>'ios',
'BIZ_ANDROID_PATH'=>'android',
'USER_GROWTH_DIARY_POINT_MAX'=>'10',
'USER_GROWTH_DIARY_DELETE_SCORE'=>'0',
'USER_GROWTH_DIARY_DELETE_POINT'=>'-5',
);
 ?>