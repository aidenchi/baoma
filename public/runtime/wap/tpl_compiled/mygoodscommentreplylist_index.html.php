...
?>'" style=" border-right:1px solid #ccc;">店铺点评(共<span id="my_supplier_comment_count"><?php echo $this->_var['data']['my_supplier_comment_count']; ?></span>条)</li>
				   <li id="one2" onclick="javascrtpt:window.location.href='<?php
echo parse_wap_url_tag("u:index|mygoodscommentlist#index|"."".""); 
?>'"  class="hover" style="border-right:1px solid #ccc;">商品点评(共<span id="my_goods_comment_count"><?php echo $this->_var['data']['my_goods_comment_count']; ?></span>条)</li>
				</ul>
			</div>
			-->
			<div class="Contentbox">  
			   <div id="con_one_1" class="hover">
					...
					<div class="list-view">
						<div class="list_title"><i class="fa fa-bullhorn"></i>共<span id="my_goods_comment_count"><?php echo $this->_var['data']['my_goods_comment_count']; ?></span>条</div>
