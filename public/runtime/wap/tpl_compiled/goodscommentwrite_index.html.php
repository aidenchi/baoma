...
<div class="wrap">
		<div class="content">
					...
					<div class="comment_list_txt">
						<input type="hidden" value="<?php echo $this->_var['request']['goods_id']; ?>" id="id">
						<input type="hidden" value="<?php echo $this->_var['request']['type']; ?>" id="type">
...
function  add_comment(){
	...
	var ajaxurl = '<?php
echo parse_wap_url_tag("u:index|add_deal_dp|"."".""); 
?>';
	$.ajax({
		url:ajaxurl,
		data:query,
...
echo parse_wap_url_tag("u:index|goodscommentlist|"."type=".$this->_var['request']['type']."&goods_id=".$this->_var['request']['goods_id']."".""); 
?>";
				},2000);
			}else{
				//alert(data.info);
