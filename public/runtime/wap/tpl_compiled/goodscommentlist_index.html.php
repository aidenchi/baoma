...
<div class="wrap back-white">
			<div class="content">
				...
				<div class="list-view">
					<div class="list_title">共<?php echo $this->_var['data']['message_count']; ?>条点评</div>
					<ul class="shop_comment_list">
						<?php $_from = $this->_var['data']['message_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'message');if (count($_from)):
...
$k = array (
  ...
  'uid' => $this->_var['message']['user_id'],
  'type' => 'small',
);
echo $k['name']($k['uid'],$k['type']);
?>'>-->
								<?php echo $this->_var['message']['user_name']; ?>
							</div>
...
echo parse_wap_url_tag("u:index|goodscommentwrite#index|"."goods_id=".$this->_var['data']['goods_id']."".""); 
?>'"/> 
				</div>
