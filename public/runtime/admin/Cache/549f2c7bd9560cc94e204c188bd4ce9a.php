...
<body>
	...
	<table class="form" cellpadding=0 cellspacing=0>
		...
		<tr>
			...
			<td class="item_input">
				贝欧 v0.1 <span id="version_tip"></span>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="item_input">
				帖子<?php echo ($topic_count); ?><?php if($reminder['topic_count'] > 0): ?>(<a href="<?php echo u("Topic/index");?>" style="color:#f60;"><?php echo ($reminder["topic_count"]); ?>新</a>)<?php endif; ?>，商家点评<?php echo ($dp_count); ?><?php if($reminder['dp_count'] > 0): ?>(<a href="<?php echo u("SupplierLocation/index");?>" style="color:#f60;"><?php echo ($reminder["dp_count"]); ?>新</a>)<?php endif; ?>，<!--会员留言<?php echo ($msg_count); ?><?php if($reminder['msg_count'] > 0): ?>(<a href="<?php echo u("Message/index",array("is_buy"=>0));?>" style="color:#f60;"><?php echo ($reminder["msg_count"]); ?>新</a>)<?php endif; ?>，购物点评-->商品点评<?php echo ($buy_msg_count); ?><?php if($reminder['buy_msg_count'] > 0): ?>(<a href="<?php echo u("Message/index",array("is_buy"=>1));?>" style="color:#f60;"><?php echo ($reminder["buy_msg_count"]); ?>新</a>)<?php endif; ?>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="item_input">
				请访问 <a href="http://www.ishareyun.com" target="_blank" title="云享新创">http://www.ishareyun.com</a>
			</td>
		</tr>
		-->
		<tr>
