...
class do_binding_mobile{
	public function index()
	{
		...
		$db_code = $GLOBALS['db']->getRow("select code,add_time from ".DB_PREFIX."sms_mobile_verify where status=0 and mobile_phone = '$new_mobile' and type=0 order by id desc");
