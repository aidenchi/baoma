		...
		if ($user_id > 0){
			...
			if ($supplier_location){
				...
				*/
				...
				if ($order_id > 0){
					//判断该门店是否有：自主下单商品 is_shop = 2
					$sql = "select * from ".DB_PREFIX."deal where is_shop = 2 and supplier_id =".$supplier_id." and account_id = ". $supplier_location['id'];
					...
					if (!$deal){
						...
						$deal['is_shop'] = 2;//0:团购;1:商品; 2:门店自主下单商品;
